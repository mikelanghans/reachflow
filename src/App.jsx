...
const TEMPLATES = [
  ...
  },
  {
    ...
    replyRate: "20–28%",
    bestFor:
      "Coaches, consultants, and course creators booking discovery calls",
    steps: [
      {
        day: 0,
        type: "👤 Visit Profile",
        msg: "AI visits the prospect's profile first. They'll see your name in their 'Who viewed your profile' notifications before you've said anything.",
        why: "Plants your name with zero commitment. Coaches especially benefit here — prospects often check who's been looking before they accept anything.",
      },
      {
        day: 0,
        type: "➕ Follow Profile",
        msg: "AI follows the prospect right after viewing.",
        why: "A second low-friction touchpoint. Following (rather than connecting) feels less forward and builds familiarity first.",
      },
      {
        day: 0,
        type: "♥ Like Recent Post",
        msg: "AI likes their most recent post.",
        why: "Genuine, visible engagement. By now they've seen your name three times with no ask attached.",
      },
      {
        day: 0,
        type: "💬 Comment on Post",
        msg: "AI writes a real, contextual comment referencing what they actually posted — not a generic line.",
        why: "The highest-signal step. A thoughtful comment shows you read their content, which matters a lot in coaching niches built on trust.",
      },
      {
        day: 0,
        type: "✉ Send Connection Request",
        msg: "Hi {{first_name}}, I've really enjoyed your posts on [topic] — especially your take on [specific thing]. I work with [ICP] on [outcome] and would love to connect.",
        why: "Referencing their actual content makes this feel earned, not cold. Acceptance rates run well above a blind connection request.",
      },
      {
        day: 5,
        type: "🔀 Check: Request Accepted?",
        msg: "AI checks whether the connection request was accepted after a 5-day wait.",
        why: "This is the branch point. Coaches' audiences can be slow to respond — 5 days gives room without letting the lead go cold.",
      },
      {
        day: 5,
        type: "✅ If Accepted → Send Message",
        msg: "Hi {{first_name}}, thanks for connecting! I help [ICP] with [outcome] — would love to hear what you're working on right now. Worth a quick chat?",
        why: "Leads with curiosity about them, not a pitch. Easiest possible first reply to give.",
      },
      {
        day: 7,
        type: "❌ If Not Accepted → Visit Profile + Follow Company",
        msg: "AI re-visits the profile and follows their company page.",
        why: "A gentle second wave of visibility instead of giving up. Following the company is a softer signal than chasing the person directly.",
      },
      {
        day: 8,
        type: "❌ Withdraw Request / Send InMail",
        msg: "AI withdraws the unanswered connection request, then sends a short InMail: Hi {{first_name}}, no worries if now's not the time to connect — wanted to share [resource/insight] in case it's useful.",
        why: "Withdrawing keeps your pending-request count clean for future outreach. The InMail gives one more low-pressure touch without being pushy.",
      },
      {
        day: 10,
        type: "❌ Comment on Post (final touch)",
        msg: "AI leaves one more genuine comment on a newer post.",
        why: "A last, no-ask touchpoint. Keeps you visible for when their situation changes, without it feeling like chasing.",
      },
    ],
  },
];
...
const TEMPLATE_FLOWS = {
  1: [
    // SaaS Sales Demo
    {
      ...
      delay: 0,
      content:
        "Hi {{first_name}}, I noticed {{company}} is scaling fast — I work with similar teams on [specific problem]. Thought it'd be worth connecting.",
    },
    {
      id: 2,
      type: "message",
      ...
      delay: 3,
      content:
        "Thanks for connecting, {{first_name}}. Quick question — is [specific challenge] something that's on your radar right now at {{company}}?",
    },
    {
      id: 3,
      type: "message",
      ...
      delay: 4,
      content:
        "Thought this might be useful — [relevant insight or resource]. Happy to walk you through how we've helped teams like {{company}} with this. Worth a 20 min call?",
    },
  ...
  2: [
    // Technical Recruiting
    {
      ...
      delay: 0,
      content:
        "Hi {{first_name}}, your work on [specific tech/project] caught my eye. I'm connecting with senior [role] engineers — would love to be in your network.",
    },
    {
      id: 2,
      type: "message",
      ...
      delay: 4,
      content:
        "{{first_name}}, working on something I think you'd find interesting — a [role] role at [company type] using [tech stack]. No pressure at all, but curious if you're open to a conversation?",
    },
    {
      id: 3,
      type: "message",
      ...
      delay: 5,
      content:
        "Still thinking of you for this one, {{first_name}}. The team is strong and the problem space is genuinely interesting. Happy to share more if timing's ever right.",
    },
    { id: 4, type: "end", label: "End sequence", outcome: "no_reply" },
  ],
  3: [
    // Agency New Business
    {
      ...
      delay: 0,
      content:
        "Hi {{first_name}}, I work with [industry] companies on [outcome — e.g. 'filling their pipeline with qualified meetings']. Thought we'd be worth connecting.",
    },
    {
      id: 2,
      type: "message",
      ...
      delay: 3,
      content:
        "We recently helped [similar company type] go from [X] to [Y] in [timeframe]. Not sure if the timing's right for {{company}}, but happy to share what we did if useful?",
    },
    {
      id: 3,
      type: "message",
      ...
      delay: 5,
      content:
        "Last message — I know inboxes are busy. If you ever want to compare notes on what's working for outreach in [their industry], I'm an open book. No pitch.",
    },
    { id: 4, type: "end", label: "End sequence", outcome: "no_reply" },
  ],
  4: [
    // Warm Network Reactivation
    {
      ...
      delay: 0,
      content:
        "{{first_name}}! Been a while. I saw {{company}} has been [recent news/milestone] — congrats. Hope things are going well on your end.",
    },
    {
      id: 2,
      type: "message",
      ...
      delay: 2,
      content:
        "I've been working on something I think you'd find interesting given your background in [area]. Would love to get your take on it over a quick call?",
    },
  ...
  5: [
    // Social Warming Sequence
    {
      ...
      type: "view_profile",
      delay: 0,
      note: "Visits the prospect's profile. They'll see your name in their 'Who viewed your profile' notifications.",
    },
    {
      id: 2,
      type: "like_post",
    ...
    },
    {
      ...
      note: "",
      promptHint:
        "Write a genuine, contextual comment referencing what they actually posted. 1-2 sentences. No pitch.",
    },
    {
      id: 4,
      type: "comment_post",
      ...
      note: "",
      promptHint:
        "Comment on a different post from the previous week, on a different topic, to show breadth rather than a one-off.",
    },
    {
      id: 5,
      ...
      delay: 1,
      content:
        "Hi {{first_name}}, I've been following your posts on [topic] — your take on [specific thing] really resonated. I work with [ICP] on [outcome]. Would love to connect.",
    },
    {
      id: 6,
      type: "ai_convo",
      delay: 1,
      note: "AI manages the conversation — responding to replies, handling objections, and steering toward a booked call.",
      goal: "book_meeting",
    },
  ],
  6: [
    // Coach Client Outreach — true branch on whether the connection was accepted
    {
      id: 1,
      type: "view_profile",
      delay: 0,
      note: "Visits the prospect's profile first. They'll see your name in their 'Who viewed your profile' notifications before you've said anything.",
    },
    {
      id: 2,
      type: "follow_profile",
      delay: 0,
      note: "Follows the prospect right after viewing — a second low-friction touchpoint.",
    },
    {
      id: 3,
      type: "like_post",
    ...
    },
    {
      ...
      note: "",
      promptHint:
        "Write a real, contextual comment referencing what they actually posted — not a generic line.",
    },
    {
      id: 5,
      type: "send_connection_request",
      delay: 0,
      content:
        "Hi {{first_name}}, I've really enjoyed your posts on [topic] — especially your take on [specific thing]. I work with [ICP] on [outcome] and would love to connect.",
    },
    {
      id: 6,
      type: "condition",
      ...
      yes: [
        {
          ...
          delay: 0,
          content:
            "Hi {{first_name}}, thanks for connecting! I help [ICP] with [outcome] — would love to hear what you're working on right now. Worth a quick chat?",
        },
      ...
      no: [
        {
          ...
          type: "view_profile",
          delay: 2,
          note: "Re-visits the profile for a second wave of visibility instead of giving up.",
        },
        {
          id: 10,
          type: "follow_company",
          delay: 0,
          note: "Follows their company page — a softer signal than chasing the person directly.",
        },
        {
          id: 11,
          type: "withdraw_request",
          delay: 1,
          note: "Withdraws the unanswered connection request to keep your pending-invite count healthy.",
        },
        {
          id: 12,
          type: "send_inmail",
          delay: 0,
          content:
            "Hi {{first_name}}, no worries if now's not the time to connect — wanted to share [resource/insight] in case it's useful.",
        },
        {
          id: 13,
          type: "comment_post",
          ...
          note: "",
          promptHint:
            "Leave one more genuine comment on a newer post — a last, no-ask touchpoint.",
        },
...
function NewCampaignModal({
  ...
  const [name, setCampaignName] = useState(
    templateName ? `${templateName} Campaign` : "",
  );
        ...
        >
          ...
          <button
            ...
            style={{
              background: "transparent",
              border: "none",
              color: launching ? T.faint : T.muted,
          ...
          {step === 0 && (
            <>
              ...
              {templateName && (
                ...
                >
                  <span>⑃</span> Starting from the{" "}
                  <strong>{templateName}</strong> template — steps will be
                  pre-loaded in the Flow Builder.
                </div>
              )}
              <div style={{ marginBottom: 14 }}>
                <div
              ...
              <div style={{ textAlign: "center", padding: "0.5rem 0 1.5rem" }}>
                ...
                >
                  <button
                    ...
                    disabled={launching}
                    style={{
                      background: launching ? T.faint : T.accent,
                      color: launching ? T.muted : "#0d1117",
                      border: "none",
                      borderRadius: 10,
                      padding: "12px",
                      cursor: launching ? "default" : "pointer",
                  ...
                  <button
                    ...
                    style={{
                      background: T.card,
                      color: launching ? T.faint : T.text,
                      border: `1px solid ${T.border}`,
                      borderRadius: 10,
                      padding: "12px",
                      cursor: launching ? "default" : "pointer",
...
function FlowBuilder({
  ...
  const [flow, setFlow] = useState(() =>
    Array.isArray(savedFlow)
      ? savedFlow
      : Array.isArray(campaign?.flow)
        ? campaign.flow
        : [],
  );
  ...
  const loadTemplate = (id) => {
    ...
    if (
      flow.length > 0 &&
      !window.confirm(
        "This replaces the current flow with the template. Continue?",
      )
    )
      return;
            ...
            <>
              ...
              <div style={{ position: "relative" }}>
                <button
                  ...
                  style={{
                    background: "rgba(45,206,152,0.10)",
                    color: T.green,
                  ...
                  >
                    {TEMPLATES.map((t) => (
                      ...
                      >
                        ...
                        <div
                          style={{ color: T.muted, fontSize: 11, marginTop: 1 }}
                        >
                          {t.bestFor}
                        </div>
                      </button>
    ...
    >
      ...
      {showNewCampaign && (
        <NewCampaignModal
          ...
          clients={clients}
          initialFlow={
            pendingTemplate ? TEMPLATE_FLOWS[pendingTemplate.id] : null
          }
          templateName={pendingTemplate?.name || null}
          launching={launchingFlow}
          onLaunchFlow={async (c) => {
